...
public final class WicketFileUtil {
    ...
    public static PsiDirectory selectTargetDirectory(@NotNull final String packageName, @NotNull final Project project, @NotNull final Module module) {
        ...
        final ReadAction<VirtualFile> readAction = new ReadAction<VirtualFile>() {
            @Override
        ...
        final RunResult<VirtualFile> result = new RunResult<>(readAction);
        VirtualFile selectedRoot = ReadAction.compute(result::run).getResultObject();
        ...
        try {
            return new WriteCommandAction<PsiDirectory>(project, CodeInsightBundle.message("create.directory.command")) {
                @Override
                protected void run(@NotNull Result<? super PsiDirectory> result) throws Throwable {
    ...
    public static PsiElement createFileFromWicketForge(@NotNull String fileName, @NotNull PsiDirectory directory, @NotNull String templateName) {
        ...
        final FileWicketForge template = FileWicketForgeManager.getInstance().getJ2eeWicketForge(templateName);

        Properties props = FileWicketForgeManager.getInstance().getDefaultProperties();
